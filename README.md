...
| Save interval (minutes)       | `0`              | How long should the chat log wait before saving to disk? This is in minutes, the minimum is 1. Set to 0 <br/>to only save when paused (warning: setting to <5 will lag a lot). All values try to save on exit.                                                                                                                                                                  | `text.chatpatches.chatlogSaveInterval`    |
