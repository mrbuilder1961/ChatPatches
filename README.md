...
| Chat search screen        | `true`                  | Should the chat screen contain a search feature and other capabilities? Note that this uses a custom, vanilla-overriding screen that may break or cause issues with other mods.                          | `text.chatpatches.chatSearchScreen` |
...
details. You can also visit the [Modrinth Changelog page](https://modrinth.com/mod/chatpatches/changelog?g=1.19.3) for a filtered version and it will list all changes for each mod version.
