...
|  Timestamp decoration text   | `"[$]"`                   | The string of '&' + formatting codes and/or decoration text that create the timestamp. Requires '$' as a placeholder for the formatted time, as specified in the option above.                                                                                                                           | `timeFormat`           |
