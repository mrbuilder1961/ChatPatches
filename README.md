...
| Dynamic Shifting              | `true`           | Should the chat be shifted dynamically based on armour and health? If turned off, the chat is a constant height. If turned on, the chat dynamically adjusts. The base shift is based on the Shift Chat config.                                                                                                                                                                                                                        | `text.chatpatches.useDynamicShifting`            |
