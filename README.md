...
| Shift chat                    | `0`              | Shifts the chat interface up to not obstruct the armor bar and/or health. Default is 0 with dynamic shift enabled, for vanilla behavior disable that as well.                                                                                                                                                                          | `text.chatpatches.shiftChat`              |
| Dynamic chat shifting         | `true`           | Should the chat be shifted dynamically based on armor and health? If disabled, the chat is shifted a constant amount according to shiftChat. If enabled, the chat dynamically adjusts based on health and armor, alongside the base shift.                                                                                             | `text.chatpatches.dynamicShiftChat`       |
