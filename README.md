...
|        Timestamp color        | `0xFF55FF` (light_purple) | The color that's filled in where it would otherwise be blank in the resulting timestamp. To use this with other formatting modifiers, use '&r' in the decoration text option.                                                                                           | `text.chatpatches.timeColor`            |
...
|       Hover text color        | `0xFFFFFF` (white)        | The color that's filled in where it would otherwise be blank white in the resulting hover text. To use this with other formatting modifiers, use '&r' in the decoration text option.                                                                                    | `text.chatpatches.hoverColor`           |
...
|     Message counter color     | `0xFFFF55` (yellow)       | The color that's filled in where it would otherwise be blank white in the resulting duplicate counter. To use this with other formatting modifiers, use '&r' in the decoration text option. Still applies to the CompactChat method, if enabled.                        | `text.chatpatches.counterColor`         |
...
|        Boundary color         | `0x55FFFF` (aqua)         | The color that's filled in where it would otherwise be blank white in the resulting boundary line. To use this with other formatting modifiers, use '&r' in the decoration text option.                                                                                 | `text.chatpatches.boundaryColor`        |
...
|        Playername text        | `"<$>"`                   | The text that replaces the playername in chat messages. '$' serves as a placeholder for the name, so vanilla's format is '<$>'. Only applies to player-sent messages.                                                                                                   | `text.chatpatches.nameFormat`           |
|       Playername color        | `0xFFFFFF` (white)        | The color that's filled in where it would otherwise be white in the formatted playername. To use this with other formatting modifiers, use '&r' in the decoration text option.                                                                                          | `text.chatpatches.nameColor`            |
...
|       Reply text format       | `"/msg $ "`               | The text that is filled into the chat box after right-clicking on a chat message and clicking on the 'Reply' button in the context menu. '$' is required and will be filled with the message sender's name.                                                             | `text.chatpatches.contextReplyFormat`   |
...
|          Formatting           | `false`                   | Should the search query allow matching text according to formatting modifiers? "abc" would match "abc" and "§e§labc§r"; with modifiers it would only match "abc" and not "§e§labc§r". Hex colors can be matched in the format "&#RRGGBB", however it no worky.          | `text.chatpatches.search.formatting`    |
