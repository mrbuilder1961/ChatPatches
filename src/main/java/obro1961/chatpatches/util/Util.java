...
public class Util {
	...
	public static final GameProfile NIL_SENDER = new GameProfile(NIL_UUID, "");
	...
	public static MutableText formatString(String plain) {
		return new LiteralText( plain.replaceAll("(?i)(?m)(?<!\\\\)&([0-9a-fk-or])", "§$1") );
	}

	public static MutableText empty(Style style) {
		return new LiteralText("").setStyle(style != null ? style : Style.EMPTY);
	}
}
