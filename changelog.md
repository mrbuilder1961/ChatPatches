...
- Config and chat log I/O events are now executed on I/O threads, which should prevent any potential freezing ([#227](https://www.github.com/mrbuilder1961/ChatPatches/issues/227))
